...
//a)
let x: string = "Hallo"; //x wird mit 'Hallo' initialisiert, let -> neuer Wert kann zugewiesen werden
...
function func4(): void {
    let x: string = "Blubb"; //neue Variable x mit dem Wert 'Blubb' wird angelegt
